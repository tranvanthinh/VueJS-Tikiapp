            ...
            <div class="container mt-4">
                ...
                <div class="row">
                    <div class="col col-md-12">
                        <table class="table table-bordered">
                            ...
                            <tbody id="datarow">
                                <tr>
                                    <td>1</td>
                                    <td>
                                        <img src="/img/product/ipad4.png" class="hinhdaidien">
                                    </td>
                                ...
                                <tr>
                                    <td>2</td>
                                    <td>
                                        <img src="/img/product/nokia-asha-311.jpg" class="hinhdaidien">
                                    </td>
                                ...
                                <tr>
                                    <td>3</td>
                                    <td>
                                        <img src="/img/product/iphone5-white.jpeg" class="hinhdaidien">
                                    </td>
                        ...
                        <router-link to="/" class="btn btn-warning btn-md float-left" ><i class="fa fa-arrow-left"
                            aria-hidden="true"></i>&nbsp;Quay về trang chủ
                        </router-link>
                            
                        <router-link to="" class="btn btn-primary btn-md"><i
